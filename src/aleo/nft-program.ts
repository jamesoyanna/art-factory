export const NFTProgramId = 'blocky_nfts.aleo';

export const NFTProgram = `program blocky_nfts.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1gaeutqjd0d7jaz3pslq8q02an939uvyd63ac4pgvrknnf9phacqqv84jt0;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as blocky_nfts.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as blocky_nfts.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as blocky_nfts.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as blocky_nfts.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as blocky_nfts.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as blocky_nfts.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as blocky_nfts.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as blocky_nfts.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as blocky_nfts.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as blocky_nfts.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as blocky_nfts.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as blocky_nfts.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as blocky_nfts.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as blocky_nfts.aleo/convert_public_to_private.future;
